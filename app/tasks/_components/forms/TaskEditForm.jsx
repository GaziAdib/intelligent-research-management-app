        ...
        <div className="flex flex-col space-y-3 pt-4">
          {initialData?.leaderId !== currentUserId && (
            <button
              ...
              className="w-full bg-blue-600 hover:bg-blue-700 cursor-pointer text-white text-sm md:text-base py-2 px-4 md:py-3 md:px-6 rounded-lg transition-all duration-200 disabled:opacity-50"
            >
